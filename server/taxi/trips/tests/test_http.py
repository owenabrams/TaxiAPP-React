import base64 # new under authentication
import json # new under authentication
...
from trips.models import Trip # new under HTTP

PASSWORD = 'pAssw0rd!'


def create_user(username='user@example.com', password=PASSWORD): # new under authentication
...
class HttpTripTest(APITestCase): #new under HTTP
    def setUp(self):
        user = create_user()
    ...
    def test_user_can_retrieve_trip_by_id(self): #new under HTTP
